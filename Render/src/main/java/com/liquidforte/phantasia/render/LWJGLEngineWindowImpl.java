package com.liquidforte.phantasia.render;
...
public class LWJGLEngineWindowImpl implements EngineWindow {
    private final EngineSettings settings;
    private final InternalTileGrid tileGrid;
    private String title = "Phantasia";
    private long window;

    @Inject
    public LWJGLEngineWindowImpl(EngineSettings settings, InternalTileGrid tileGrid) {
        this.settings = settings;
        title = settings.getWindowTitle();
